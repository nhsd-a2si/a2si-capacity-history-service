...
import com.nhsd.a2si.capacity.historyservice.services.waittime.WaitTimeService;
...
public class WaitTimes {
    ...
    public Response addWaitTime(@Valid com.nhsd.a2si.capacity.historyservice.api.model.waittime.WaitTime waitTime) {
